...
const s: Record<string, React.CSSProperties> = {
  ...
  slideWrap:      { display: 'flex', alignItems: 'center', gap: 16, marginBottom: 16 },
  arrow:          { width: 44, height: 44, borderRadius: '50%', border: '2px solid #ddd', background: 'white', fontSize: 24, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', color: '#2c3e50', fontWeight: 700 },
  ...
  slideImg:       { width: '100%', height: 280, objectFit: 'cover' },
  slideBadgeRow:  { display: 'flex', gap: 8, padding: '12px 20px 0', flexWrap: 'wrap' },
  verifiedBadge:  { fontSize: 11, fontWeight: 600, color: '#27ae60' },
  negoBadge:      { padding: '2px 8px', borderRadius: 20, fontSize: 11, fontWeight: 600, color: 'white', background: '#2980b9' },
  slideName:      { fontSize: 20, fontWeight: 700, color: '#222', padding: '8px 20px 4px' },
  slideLoc:       { fontSize: 13, color: '#888', padding: '0 20px 12px' },
  slideGrid:      { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8, padding: '0 20px 16px' },
  slideContact:   { background: '#f0f7ff', margin: '0 20px 16px', borderRadius: 10, padding: '14px 16px' },
