...
const s: Record<string, React.CSSProperties> = {
  ...
  slideWrap:      { display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 },
  arrow:          { width: 36, height: 36, borderRadius: '50%', border: '2px solid #ddd', background: 'white', fontSize: 20, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, boxShadow: '0 2px 8px rgba(0,0,0,0.08)', color: '#2c3e50', fontWeight: 700 },
  ...
  slideImg:       { width: '100%', height: 180, objectFit: 'cover' },
  slideBadgeRow:  { display: 'flex', gap: 6, padding: '10px 16px 0', flexWrap: 'wrap' },
  verifiedBadge:  { fontSize: 10, fontWeight: 600, color: '#27ae60' },
  negoBadge:      { padding: '2px 6px', borderRadius: 20, fontSize: 10, fontWeight: 600, color: 'white', background: '#2980b9' },
  slideName:      { fontSize: 16, fontWeight: 700, color: '#222', padding: '6px 16px 2px' },
  slideLoc:       { fontSize: 12, color: '#888', padding: '0 16px 10px' },
  slideGrid:      { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 6, padding: '0 16px 12px' },
  slideContact:   { background: '#f0f7ff', margin: '0 16px 12px', borderRadius: 8, padding: '10px 14px' },
