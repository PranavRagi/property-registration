...
const s: Record<string, React.CSSProperties> = {
  ...
  // Floor preview
  floorPreview: { fontSize: 12, color: '#2980b9', background: '#eef7ff', padding: '7px 10px', borderRadius: 4, marginTop: 4 },
  // Negotiable toggle
  toggleRow:    { display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' },
  toggleBtn:    { padding: '9px 18px', borderRadius: 6, border: 'none', fontSize: 13, fontWeight: 600, cursor: 'pointer' },
  toggleOn:     { background: '#eef7f1', color: '#27ae60', border: '1px solid #27ae60' },
  toggleOff:    { background: '#fdf3f2', color: '#c0392b', border: '1px solid #e74c3c' },
  toggleHint:   { fontSize: 11, color: '#888', margin: 0 },
}